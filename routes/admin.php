...
use LoafPanel\Http\Controllers\Admin;
use LoafPanel\Http\Middleware\Admin\Servers\ServerInstalled;
...
Route::group(['prefix' => 'update'], function () {
    ...
    Route::post('/run', [Admin\UpdateController::class, 'update'])->name('admin.update.run');
});
