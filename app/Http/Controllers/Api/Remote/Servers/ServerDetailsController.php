...
namespace LoafPanel\Http\Controllers\Api\Remote\Servers;
...
use LoafPanel\Services\Eggs\EggConfigurationService;
use LoafPanel\Repositories\Eloquent\ServerRepository;
use LoafPanel\Http\Resources\Wings\ServerConfigurationCollection;
use LoafPanel\Services\Servers\ServerConfigurationStructureService;
...
class ServerDetailsController extends Controller
{
    ...
    {
        /** @var \LoafPanel\Models\Node $node */
    ...
    public function resetState(Request $request): JsonResponse
    {
        ...
        $this->connection->transaction(function () use ($node, $servers) {
            ...
            foreach ($servers as $server) {
                /** @var \LoafPanel\Models\ActivityLog|null $activity */
