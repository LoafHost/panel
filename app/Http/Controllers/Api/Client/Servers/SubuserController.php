...
use LoafPanel\Services\Subusers\SubuserCreationService;
use LoafPanel\Repositories\Wings\DaemonServerRepository;
use LoafPanel\Transformers\Api\Client\SubuserTransformer;
...
use LoafPanel\Http\Requests\Api\Client\Servers\Subusers\GetSubuserRequest;
use LoafPanel\Http\Requests\Api\Client\Servers\Subusers\StoreSubuserRequest;
use LoafPanel\Http\Requests\Api\Client\Servers\Subusers\DeleteSubuserRequest;
use LoafPanel\Http\Requests\Api\Client\Servers\Subusers\UpdateSubuserRequest;
...
class SubuserController extends ClientApiController
{
     ...
     * @throws \LoafPanel\Exceptions\Service\Subuser\ServerSubuserExistsException
     * @throws \LoafPanel\Exceptions\Service\Subuser\UserIsServerOwnerException
     * @throws \Throwable
     */
    ...
    {
        /** @var \LoafPanel\Models\Subuser $subuser */
        $subuser = $request->attributes->get('subuser');
