...
namespace LoafPanel\Http\Controllers\Admin\Settings;

use Illuminate\View\View;
use Illuminate\Http\Request;
use Illuminate\Http\Response;
use Illuminate\Contracts\Console\Kernel;
use LoafPanel\Notifications\MailTested;
use Illuminate\View\Factory as ViewFactory;
use Illuminate\Support\Facades\Notification;
use LoafPanel\Exceptions\DisplayException;
use LoafPanel\Http\Controllers\Controller;
use Illuminate\Contracts\Encryption\Encrypter;
use LoafPanel\Providers\SettingsServiceProvider;
use Illuminate\Contracts\Config\Repository as ConfigRepository;
use LoafPanel\Contracts\Repository\SettingsRepositoryInterface;
use LoafPanel\Http\Requests\Admin\Settings\MailSettingsFormRequest;
