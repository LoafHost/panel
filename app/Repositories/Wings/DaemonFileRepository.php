...
use LoafPanel\Exceptions\Http\Server\FileSizeTooLargeException;
use LoafPanel\Exceptions\Http\Connection\DaemonConnectionException;

/**
 * @method \LoafPanel\Repositories\Wings\DaemonFileRepository setNode(\LoafPanel\Models\Node $node)
 * @method \LoafPanel\Repositories\Wings\DaemonFileRepository setServer(\LoafPanel\Models\Server $server)
 */
