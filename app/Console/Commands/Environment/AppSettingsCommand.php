...
namespace LoafPanel\Console\Commands\Environment;
...
class AppSettingsCommand extends Command
{
    ...
    protected $signature = 'lp:environment:setup
     ...
     *
     * @throws \LoafPanel\Exceptions\LoafPanelException
     */
    public function handle(): int
    {
        ...
        $this->variables['APP_SERVICE_AUTHOR'] = $this->option('author') ?? $this->ask(
            'Egg Author Email',
            config('app.service.author', 'unknown@unknown.com')
        );
        ...
        $this->output->comment('Help us improve Loaf Panel by sending anonymous telemetry data. You can find more information at https://loaf-panel.com/telemetry.');
        $this->variables['LOAFPANEL_TELEMETRY_ENABLED'] = $this->option('telemetry') ?? $this->confirm(
            'Enable sending anonymous telemetry data?',
            config('loafpanel.telemetry.enabled', true)
        ) ? 'true' : 'false';
